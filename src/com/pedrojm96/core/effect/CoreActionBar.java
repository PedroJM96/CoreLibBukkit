...
public class CoreActionBar {
	...
	private static void sendPos_1_18_Pre_1_19(Player player, String message)
	{
	    try
	    {
	    	...
	    	CoreReflection.sendPacketPos_1_18_Pre_1_19(player, packet);
	    }
	...
	private static void sendPos_1_19_Pre_1_19_2(Player player, String message)
	{
	    try
	    {
	    	Class<?> chatClass = CoreReflection.getClass("net.minecraft.network.chat.IChatBaseComponent");
	...
	private static void sendPos_1_17_Pre_1_18(Player player, String message)
	{
	    try
	    
	    {
	    	...
	    	// c es igual a GAME_INFO
	    	Object packet = constructor.newInstance(ationmesage,chatMessageTypeClass.getField("c").get(null),player.getUniqueId()  );
	    	CoreReflection.sendPacketPos_1_17_Pre_1_18(player, packet);
	    }
	    catch (Exception var11)
	    {
	      System.out.println("Please report the bug at: https://github.com/PedroJM96/CoreLibBukkit");
